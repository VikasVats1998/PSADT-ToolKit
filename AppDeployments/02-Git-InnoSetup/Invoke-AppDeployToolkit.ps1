...
in AppConfig.ps1; the Install/Uninstall/Repair logic is in InstallLogic.ps1
(generic, not app-specific). Both are dot-sourced below. See README.md for
test instructions.
...
# InstallLogic.ps1 = the standard Install/Uninstall/Repair pattern (generic).
. "$PSScriptRoot\AppConfig.ps1"
. "$PSScriptRoot\InstallLogic.ps1"
